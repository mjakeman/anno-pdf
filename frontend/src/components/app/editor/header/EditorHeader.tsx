            ...
            <div className="flex flex-row items-center justify-between gap-2">
                ...
                <div className="relative">
                    ...
                    <span className={`absolute mt-2 z-50 right-0 ${!showSharePopup ? "hidden" : "block"} `}>
                        <SharePopup owner={annoDocument.owner} docName={annoDocument.title} onOutsideClick={() => setShowSharePopup(false)} onSharePress={(email) => inviteUser(email)} peopleSharedWith={annoDocument.sharedWith}/>
                    </span>
