...
export default function ActionMenu({onDownload, onCopy, onDelete} : ActionMenuProps ) {
    ...
    return (
        <div className="flex flex-row items-center">
            <button onClick={() => setShowExpandedMenu(!showExpandedMenu)} type="button" className="z-50 bg-anno-red-primary dark:bg-anno-red-secondary w-8 h-8 flex items-center justify-center rounded-full transition-colors hover:bg-anno-red-secondary dark:hover:bg-anno-pink">
                ...
                <div className="-ml-4 flex rounded-r-xl border-y-2 border-r-2 border-anno-red-primary dark:border-anno-red-secondary">
                    <div className="flex flex-row ml-6 mr-2 gap-2 items-stretch justify-center">
                        ...
                        <button onClick={onDownload} type="button" className="rounded-lg px-2 py-1 hover:bg-zinc-200 dark:hover:bg-anno-space-700 transition-colors">
                            <ArrowDownTrayIcon className="w-5 h-5 text-anno-red-primary dark:text-anno-pink" />
                        </button>

                        {/* TODO: maybe make this a component? */}
                        <div className="border-l-2 border-anno-pink dark:border-pink-100 my-1.5 translate-x-1/2"></div>
                        ...
                        <button onClick={onCopy} type="button" className="rounded-lg px-2 hover:bg-zinc-200 dark:hover:bg-anno-space-700 transition-colors">
                            <DocumentDuplicateIcon className="w-4 h-4 text-anno-red-primary dark:text-anno-pink" />
                        </button>
