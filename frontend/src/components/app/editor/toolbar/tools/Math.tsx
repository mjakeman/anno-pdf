...
export default function Math({id} : Props) {
    ...
    return (
        <button onClick={handleMathClick} type="button" className={`${isSelected ? 'bg-gray-200' : 'bg-white'} hover:bg-gray-200 p-2 rounded-full transition-colors dark:hover:bg-anno-space-700`}>
