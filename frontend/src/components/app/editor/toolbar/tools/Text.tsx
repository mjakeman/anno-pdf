    ...
    return (
        <span className="relative">
            <span className={`transition-all duration-300 flex flex-row gap-1 items-center rounded-full ${isSelected ? 'border-2 bg-zinc-800' : 'bg-white border-2 border-transparent'} p-1 `}>
                ...
                <button onClick={handleTextSelect} type="button" className={`bg-white ${isSelected ? 'border-2 ' : 'border-transparent border hover:bg-gray-200'}  p-1 rounded-full transition-colors dark:hover:bg-anno-space-700`}>
